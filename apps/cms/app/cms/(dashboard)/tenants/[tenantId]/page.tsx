...
import { useTenantsStore } from "@skill-learn/lib/stores/tenantsStore"
import { useRoleTemplatesStore } from "@skill-learn/lib/stores/roleTemplatesStore"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  {createUserErrors.firstName && (
                    <p className="text-sm text-red-600">{String(createUserErrors.firstName?.message ?? '')}</p>
                  )}
                </div>
                <div className="grid gap-2">
                  ...
                  {createUserErrors.lastName && (
                    <p className="text-sm text-red-600">{String(createUserErrors.lastName?.message ?? '')}</p>
                  )}
                </div>
              </div>
              <div className="grid gap-2">
                ...
                {createUserErrors.username && (
                  <p className="text-sm text-red-600">{String(createUserErrors.username?.message ?? '')}</p>
                )}
              </div>
              <div className="grid gap-2">
                ...
                {createUserErrors.password && (
                  <p className="text-sm text-red-600">{String(createUserErrors.password?.message ?? '')}</p>
                )}
              </div>
              <div className="grid gap-2">
                ...
                {createUserErrors.confirmPassword && (
                  <p className="text-sm text-red-600">{String(createUserErrors.confirmPassword?.message ?? '')}</p>
                )}
              </div>
              <div className="grid gap-2">
                ...
                {createUserErrors.email && (
                  <p className="text-sm text-red-600">{String(createUserErrors.email?.message ?? '')}</p>
                )}
              </div>
              <div className="grid gap-2">
                ...
                {createUserErrors.tenantRoleId && (
                  <p className="text-sm text-red-600">{String(createUserErrors.tenantRoleId?.message ?? '')}</p>
                )}
