    ...
    return (
        <div className="min-h-screen bg-[#F8F9FB] font-sans text-slate-900">
            ...
            <footer className="bg-slate-50 py-16 mt-20 border-t border-slate-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-sm text-slate-500">
                        <p>
                            © 2023 Skill-Learn Inc. All rights reserved.
                        </p>
                        <div className="flex items-center gap-8">
                            <Link href="/legal/privacy-policy" className="hover:text-brand-teal transition-colors">Privacy Policy</Link>
                            <Link href="#" className="hover:text-brand-teal transition-colors">Cookie Policy</Link>
                        </div>
                    </div>
                </div>
            </footer>
