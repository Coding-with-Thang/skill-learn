    ...
    >
      <section className="w-full min-h-screen bg-background pb-20">
        <div className="max-w-7xl mx-auto px-6 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
            {games.map((game) => (
              <Link key={game.id} href={game.route} className="block group h-full">
                <Card className="h-full border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-card overflow-hidden rounded-4xl flex flex-col">
          ...
          {/* Coming Soon Section */}
          <div className="mt-12 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-4xl p-12 flex flex-col items-center justify-center text-center bg-gray-50 dark:bg-gray-800/20">
