...
export default function CaseStudyPage() {
  ...
  const snapshot = [
    ...
    },
    {
      icon: Users,
      label: t("companySize"),
      value: "500 - 2,000 Employees",
      color: "text-indigo-600 bg-indigo-50",
    },
    {
      icon: Layout,
      label: t("modulesUsed"),
      value: "Gamified Learning, Analytics",
    ...
    <div className="min-h-screen bg-[#F8F9FB] font-sans pb-24">
      ...
      <div className="bg-white border-b border-gray-100 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 h-12 flex items-center justify-end gap-6">
          ...
          <Button
            variant="ghost"
            className="h-8 text-xs font-bold text-slate-600 px-3"
          >
            {t("scheduleDemo")}
          </Button>
          <div className="w-8 h-8 rounded-full bg-slate-200 border border-slate-100 overflow-hidden">
            <Image
              src="https://api.dicebear.com/7.x/avataaars/svg?seed=7"
              alt="User"
              width={32}
              height={32}
            />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <span className="px-3 py-1 bg-brand-teal/10 text-brand-teal rounded-full text-[10px] font-black uppercase tracking-wider">
                {t("successStory")}
              </span>
            ...
            <h1 className="text-4xl md:text-brand-teal lg:text-6xl font-extrabold text-[#1B1B53] mb-8 leading-[1.1] tracking-tight">
              {t("techflowHeroTitleBefore")}
              <span className="text-[#00D181]">40%</span>
              {t("techflowHeroTitleAfter")}
            </h1>
            <div className="flex items-center gap-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              <span className="flex items-center gap-2">
                <Calendar className="w-3 h-3" /> Oct 24, 2024
              </span>
              <span className="flex items-center gap-2">
                <TrendingUp className="w-3 h-3" /> Updated 2 days ago
              </span>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <aside className="lg:col-span-3 space-y-8">
            <Card className="rounded-[32px] border-none shadow-sm overflow-hidden p-8 bg-white">
              <h3 className="text-lg font-extrabold text-[#1B1B53] mb-8">
                {t("caseStudySnapshot")}
              </h3>
              <div className="space-y-6">
                {snapshot.map((item, idx) => (
                  <div
                    key={idx}
                    className="bg-slate-50/50 rounded-4xl p-4 flex items-center gap-4 group hover:bg-white hover:shadow-md transition-all"
                  >
                    <div
                      className={cn(
                        "p-2.5 rounded-xl shrink-0 group-hover:scale-110 transition-transform",
                        item.color,
                      )}
                    >
                    ...
                    <div>
                      ...
                      <p className="text-xs font-black text-[#1B1B53]">
                        {item.value}
                      </p>
                    </div>
                  </div>
            ...
            <div className="px-4">
              <div className="flex justify-between items-end mb-3">
                <span className="text-[10px] font-black text-[#1B1B53] uppercase tracking-widest">
                  {t("readingProgress")}
                </span>
                <span className="text-[10px] font-black text-brand-teal tracking-widest">
                  45%
                </span>
              </div>
          ...
          <div className="lg:col-span-9 space-y-20">
            ...
            <motion.section {...fadeInUp}>
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-2xl font-black text-[#1B1B53] uppercase tracking-wider">
                  {t("theChallenge")}
                </h2>
              </div>
              <div className="prose prose-slate max-w-none">
                <p className="text-lg text-slate-600 leading-relaxed mb-8">
                  TechFlow was experiencing a significant bottleneck in their
                  engineering team's onboarding process. With a{" "}
                  <b>rapidly growing headcount</b>, the traditional manual
                  mentorship model was failing to scale. Senior engineers were
                  spending up to 15 hours per week teaching basic architecture
                  principles to new hires, leading to project delays and
                  burnout.
                </p>
                <ul className="space-y-4 text-slate-600">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 w-1.5 h-1.5 bg-brand-teal rounded-full shrink-0" />
                    <span>
                      Inconsistent training quality across different
                      departments.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 w-1.5 h-1.5 bg-brand-teal rounded-full shrink-0" />
                    <span>
                      High churn rate within the first 6 months due to "skill
                      gaps."
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 w-1.5 h-1.5 bg-brand-teal rounded-full shrink-0" />
                    <span>
                      Loss of over $2M annually in developer productivity.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-12 bg-white border-l-4 border-brand-teal rounded-4xl-3xl p-10 shadow-sm italic relative">
                ...
                <p className="text-xl text-[#1B1B53] font-medium leading-relaxed mb-6">
                  "We reached a point where our growth was actually hurting our
                  velocity. We needed a way to automate knowledge transfer
                  without losing the human element of mentorship."
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-slate-200 overflow-hidden relative">
                    <Image
                      src="https://api.dicebear.com/7.x/avataaars/svg?seed=Gavin"
                      alt="Gavin Jenkins"
                      fill
                    />
                  </div>
                  <div>
                    <h5 className="text-sm font-black text-[#1B1B53]">
                      Gavin Jenkins
                    </h5>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                      CTO, TechFlow
            ...
            <motion.section {...fadeInUp}>
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-12">
                TechFlow implemented Skill-Learn's Enterprise platform, focusing
                on the <b>Gamified Learning</b> and <b>Custom Analytics</b>{" "}
                modules. The solution was rolled out in three phases:
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                  <h4 className="text-brand-teal font-black mb-4">
                    01. Centralized Academy
                  </h4>
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">
                    Consolidated all internal documentation into interactive
                    learning paths.
                  </p>
                </div>
                <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">
                    Automated testing to identify specific knowledge gaps before
                    projects start.
                  </p>
                </div>
              </div>
            ...
            <motion.section {...fadeInUp}>
              ...
              <Card className="rounded-[40px] border-none shadow-sm p-12 bg-white mb-12">
                <div className="flex justify-between items-start mb-12">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-[#1B1B53]">
                ...
                <div className="flex items-end gap-4 h-48">
                  <div className="flex-1 bg-slate-50 rounded-xl h-[30%] relative group">
                    <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[10px] font-bold text-slate-400 text-center w-full">
                      Pre-Implementation
                    </div>
                  </div>
                  ...
                  <div className="flex-1 bg-brand-teal rounded-xl h-full relative group">
                    <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[10px] font-bold text-slate-600 text-center w-full">
                      Post-Implementation
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-[32px] border border-slate-100 text-center space-y-2 hover:translate-y-[-4px] transition-all">
                  <div className="text-3xl font-black text-brand-teal-dark">
                    15d
                  </div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                    Onboarding Reduced
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32">
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-4xl md:text-brand-teal font-extrabold mb-8 tracking-tight">
              {t("readyToSeeResults")}
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Button
                variant="outline"
                className="h-14 px-8 border-white/20 text-[#1B1B53] font-bold rounded-4xl hover:bg-white/10 backdrop-blur-md"
              >
