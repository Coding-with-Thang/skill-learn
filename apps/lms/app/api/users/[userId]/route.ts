...
export async function GET(_request: NextRequest, { params }: RouteContext<UserParams>) {
    try {
...
// PUT - Update user
export async function PUT(request: NextRequest, { params }: RouteContext<UserParams>) {
    try {
        const adminResult = await requireAdmin();
        if (adminResult instanceof NextResponse) {
            return adminResult;
...
// DELETE - Delete user
export async function DELETE(_request: NextRequest, { params }: RouteContext<UserParams>) {
    try {
        const adminResult = await requireAdmin();
        if (adminResult instanceof NextResponse) {
            return adminResult;
