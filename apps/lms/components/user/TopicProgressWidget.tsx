...
export default function TopicProgressWidget() {
  const t = useTranslations("home.topicProgress");
  const data = [
    { name: t("completed"), value: 2 },
    { name: t("remaining"), value: 18 }, // Total 20
  ];
  ...
  return (
    <Card className="w-full h-full bg-white rounded-3xl shadow-sm border border-gray-100 flex flex-col">
        ...
        <div className="w-full space-y-3 mt-4">
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">{t("notStarted")}</span>
            </div>
          ...
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">{t("beginner")}</span>
            </div>
          ...
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">{t("intermediate")}</span>
            </div>
      ...
      <CardFooter className="flex justify-end">
        <Link href="/training">{t("viewAllTopics")}</Link>
      </CardFooter>
    </Card>
  );
}
