...
export const useUsersStore = create((set, get) => ({
    ...
    return requestDeduplicator.dedupe(
      ...
      async () => {
        ...
        try {
          ...
          set({
            error: parseApiError(error) || "Failed to fetch users",
            isLoading: false,
          });
          throw error;
        }
  ...
  createUser: async (userData) => {
    ...
    try {
      ...
      set({
        error: parseApiError(error) || "Failed to create user",
        isLoading: false,
      });
      throw error;
    }
  ...
  updateUser: async (userId, userData) => {
    ...
    try {
      ...
      set({
        error: parseApiError(error) || "Failed to update user",
        isLoading: false,
      });
      throw error;
    }
  ...
  deleteUser: async (userId) => {
    ...
    try {
      ...
      set({
        error: parseApiError(error) || "Failed to delete user",
        isLoading: false,
      });
      throw error;
    }
