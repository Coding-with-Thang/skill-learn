...
export default function DailyActivities() {
  return (
    <section className="w-[50%] flex flex-col gap-4 bg-gray-50 border border-t-8 my-9 pl-4">
      ...
      <Link href="/training"><Button className="bg-blue-900 w-48 text-lg mb-4"><Play />Start</Button></Link>
      <Link href="/games"><Button className="bg-blue-900 w-48 text-lg mb-4"><Play />Play A Game</Button></Link>
    </section>
  );
}
